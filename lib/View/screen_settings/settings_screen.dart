...
import 'package:listeny/View/screen_settings/policy_dialog.dart';
import 'package:listeny/View/screen_settings/terms_and_condition.dart';
  ...
  Widget build(BuildContext context) {
    return const LicensePage(
      ...
      applicationIcon: Image(
        image: AssetImage('lib/assets/Listeny.png'),
      ),
